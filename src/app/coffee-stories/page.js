    ...
    <div style={{ padding: "3rem", backgroundColor: "#fff8f0", animation: "fadeIn 1s ease forwards", opacity: 0 }}>
      ...
      <section style={{ marginTop: "2rem", maxWidth: "700px", marginLeft: "auto", marginRight: "auto", textAlign: "left" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginTop: "1rem" }}>
          <Image src="/coffee-bean.svg" alt="Coffee Bean" width={80} height={80} style={{ animation: "zoomIn 2s ease forwards", opacity: 0 }} />
      ...
      <section style={{ marginTop: "2rem", maxWidth: "700px", marginLeft: "auto", marginRight: "auto", textAlign: "left" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginTop: "1rem" }}>
          <Image src="/coffee-bean.svg" alt="Barista" width={80} height={80} style={{ borderRadius: "8px", animation: "zoomIn 2s ease forwards", opacity: 0 }} />
          <p style={{ fontSize: "1rem", lineHeight: "1.6", color: "#4b3b2b" }}>
      ...
      <section style={{ marginTop: "2rem", maxWidth: "700px", marginLeft: "auto", marginRight: "auto", textAlign: "left" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginTop: "1rem" }}>
          <Image src="/location.svg" alt="Community" width={80} height={80} style={{ animation: "zoomIn 2s ease forwards", opacity: 0 }} />
          <p style={{ fontSize: "1rem", lineHeight: "1.6", color: "#4b3b2b" }}>
